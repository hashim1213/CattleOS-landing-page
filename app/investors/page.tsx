      ...
      <header className="border-b bg-white dark:bg-gray-950 shadow-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-3 md:py-4">
          <div className="flex items-center justify-between gap-4">
            <Link href="/" className="flex items-center gap-3 min-w-0 flex-shrink -my-12">
              <Image
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-16 md:mb-20">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#77461B]/10 border border-[#77461B]/20 rounded-full text-sm font-semibold text-[#77461B] mb-6">
                <Target className="h-4 w-4" />
                For Investors
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-foreground leading-tight">
                Transforming the Global Cattle Industry<br />
                <span className="text-[#77461B]">Through Modern Software</span>
              </h1>
            ...
            <div className="mb-16 md:mb-20">
              ...
              {/* Beef Prices Callout */}
              <div className="bg-[#77461B]/5 border-2 border-[#77461B]/20 rounded-lg p-6 md:p-8 mb-12 text-center">
                <DollarSign className="h-12 w-12 text-[#77461B] mx-auto mb-4" />
                <h3 className="text-2xl md:text-3xl font-bold mb-3 text-foreground">Beef Prices Are Rising</h3>
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                  As of today, beef prices in Canada sit at <strong className="text-[#77461B] text-xl">$6.97 CAD per pound</strong>, reflecting strong demand, supply pressures, and a tightening global market. Producers are searching for ways to improve efficiency, reduce losses, and increase profitability—especially when every pound matters.
                </p>
              </div>
            ...
            <div className="text-center">
              <Card className="border-2 border-[#77461B] bg-gradient-to-br from-[#77461B]/5 to-transparent shadow-xl">
                <CardContent className="p-8 md:p-12">
                  <Rocket className="h-16 w-16 text-[#77461B] mx-auto mb-6" />
